...
fun TodoItemEntryInput(onItemComplete: (TodoItem) -> Unit, buttonText: String = "add") {
    // 3 ways to delcare a MutableState object (https://developer.android.com/jetpack/compose/state?hl=ko)
        ...
        Row(
            ...
            TodoInputText(
                ...
                modifier = Modifier
                    .weight(1f)
                    .padding(end = 8.dp),
                onImeAction = submit    // 키보드 액션 끝났을 때
            )
